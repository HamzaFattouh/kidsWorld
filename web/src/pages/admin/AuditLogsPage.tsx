...
export function AuditLogsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        title={t('pages.audit_logs.title', 'Audit Logs')} 
        description={t('pages.audit_logs.description', 'Manage Audit Logs settings and records.')} 
        actionLabel={t('pages.audit_logs.create', 'Create Audit Logs')} 
      ...
      <Modal
        ...
        title={t('pages.audit_logs.create', 'Create Audit Logs')}
      >
