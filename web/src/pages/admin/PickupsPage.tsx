...
import { PickupForm, type PickupFormValues } from '../../components/forms/PickupForm';
import { authorizedPickupApi } from '../../api/authorizedPickup';
import type { Pickup } from '../../api/authorizedPickup';
...
export function PickupsPage() {
  ...
  const createMutation = useMutation({
    mutationFn: (payload: PickupFormValues) => authorizedPickupApi.createOne(payload),
    onSuccess: () => {
