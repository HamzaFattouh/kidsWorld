...
export function CameraPermissionsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={t('pages.camera_permissions.title', 'Camera Permissions')}
        description={t('pages.camera_permissions.description', 'Manage Camera Permissions settings and records.')}
        actionLabel={t('pages.camera_permissions.create', 'Create Camera Permissions')}
      ...
      <Modal
        ...
        title={t('pages.camera_permissions.create', 'Create Camera Permissions')}>
