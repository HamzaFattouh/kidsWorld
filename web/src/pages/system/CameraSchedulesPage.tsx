...
import { CameraScheduleForm, type CameraScheduleFormValues } from '../../components/forms/CameraScheduleForm';
import { cameraScheduleApi } from '../../api/cameraSchedule';
import type { CameraSchedule } from '../../api/cameraSchedule';
...
export function CameraSchedulesPage() {
  ...
  const createMutation = useMutation({
    mutationFn: (payload: CameraScheduleFormValues) => cameraScheduleApi.createOne(payload),
    onSuccess: () => {
  ...
  const columns: Column<CameraSchedule>[] = [
