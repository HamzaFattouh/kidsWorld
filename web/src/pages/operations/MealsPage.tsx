...
import { MealForm, type MealFormValues } from '../../components/forms/MealForm';
import { mealRecordApi } from '../../api/mealRecord';
import type { Meal } from '../../api/mealRecord';
...
export function MealsPage() {
  ...
  const createMutation = useMutation({
    mutationFn: (payload: MealFormValues) => mealRecordApi.createOne(payload),
    onSuccess: () => {
